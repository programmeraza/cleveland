    ...
    <div className="list">
      <div className="container">
        <div className="list__wrapper">
          <h1>
            Лист ожидания кандидатов <br /> на позиции «Врач» для отделений:
          </h1>
          <div className="list__wrap">
            <div className="list__content">
              <div className="list__warning">
                ...
                <p>
                  Включение в резерв не является оффером и не гарантирует
                  трудоустройство. Для части ключевых ролей возможен ранний
                  найм до открытия.
                </p>
              </div>

              <p>
                Мы формируем резерв специалистов для предзапуска CAU Hospital.
                Подача заявки добавляет вас в лист ожидания по соответствующему
                направлению. Рассмотрение заявок ведётся до запуска клиники и по
                мере открытия этапов набора.
              </p>
            ...
            <Link to="#" className="list__departments">
